...
#define STRING_CONFIG_H_AUTHOR "MJ 230228 16h00" // Who made the changes.
...
//#define CUSTOM_MACHINE_NAME "Tarantula 4.2.7"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 101.16 }
