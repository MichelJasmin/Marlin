...
#define STRING_CONFIG_H_AUTHOR "MJ 230228 20h00" // Who made the changes.
...
//#define CUSTOM_MACHINE_NAME "CR-20Pro 4.2.7"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 96.75 }
...
#define Z_CLEARANCE_BETWEEN_PROBES  3 // Z Clearance between probe points	//mj 5
...
#define ENABLE_LEVELING_AFTER_G28	//mj : refait le leveilling
...
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
  ...
  #define EEPROM_INIT_NOW   // Init EEPROM on first boot after a new build.	//mj
#endif
...
//
#define REVERSE_MENU_DIRECTION	//mj
