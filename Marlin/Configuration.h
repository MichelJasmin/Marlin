...
#define STRING_CONFIG_H_AUTHOR "(MJ 2023-12-30)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender 5+ SKR2"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  48.43
    #define DEFAULT_Ki   6.51
    #define DEFAULT_Kd  90.07
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp  173.30
  #define DEFAULT_bedKi   18.56
  #define DEFAULT_bedKd 1078.94
 ...
 * :[2,3,4,5,6,7]
 */
#define ENDSTOP_NOISE_THRESHOLD 2	//mj

// Check for stuck or disconnected endstops during homing moves.
#define DETECT_BROKEN_ENDSTOP	//mj
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 684.65 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE         { 500, 500, 20, 60 }	//mj { 300, 300, 5, 25 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -41, -8, -1.7 }
...
#define Z_PROBE_FEEDRATE_FAST (8*60)	//mj 4
...
#define Z_CLEARANCE_BETWEEN_PROBES  3 // (mm) Z Clearance between probe points  //mj 5
...
// :[-1,1]
#define X_HOME_DIR 1	//mj
#define Y_HOME_DIR 1	//mj
#define Z_HOME_DIR -1
//#define I_HOME_DIR -1
//#define J_HOME_DIR -1
//#define K_HOME_DIR -1
...
#define MIN_SOFTWARE_ENDSTOPS
  ...
  // #define MIN_SOFTWARE_ENDSTOP_Z	//mj
 ...
 */
#define RESTORE_LEVELING_AFTER_G28	//mj
...
#define HOMING_FEEDRATE_MM_M { (75*60), (75*60), (8*60) }	 // mj { (50*60), (50*60), (4*60) }
